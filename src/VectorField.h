...
class VectorField
{
    ...
    size_t m_gx         = 0;    // the goal x cell
    size_t m_gy         = 0;    // the goal y cell
...
public:
    ...
    Grid<std::vector<Direction>> compute(const cv::Mat& data, size_t spacing, size_t gx, size_t gy);
    ...
    bool isGoalCell(size_t x, size_t y) const;
