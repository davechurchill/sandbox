...
void Visualizer_Vectors::renderVectors(sf::RenderWindow & window)
{
    auto& selectedParameters = m_particleManager.parameters[
        (size_t)ParticleManager::Algorithm::Steering];
...
void Visualizer_Vectors::updateParticles(const TerrainFrame& data)
{
    PROFILE_FUNCTION();
    const cv::Mat& top = data.heightMap;
...
void Visualizer_Vectors::imgui()
{
    imguiControls();
}

void Visualizer_Vectors::process(
    const TerrainFrame & data)
{
    updateParticles(data);
}

void Visualizer_Vectors::render(
...
void Visualizer_Vectors::save(Settings & save) const
{
    const auto & parameters = m_particleManager.parameters[
        (size_t)ParticleManager::Algorithm::Steering];
    Settings::json & settings = save.section("Visualizer_Vectors");
...
void Visualizer_Vectors::load(const Settings & save)
{
    auto & parameters = m_particleManager.parameters[
        (size_t)ParticleManager::Algorithm::Steering];
    const Settings::json & settings = save.section("Visualizer_Vectors");
