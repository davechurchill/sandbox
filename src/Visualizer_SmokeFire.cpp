...
float Visualizer_SmokeFire::sampleHeight(const cv::Point2f & position) const
{
...
float Visualizer_SmokeFire::fireIntensity(const Fire & fire) const
{
...
bool Visualizer_SmokeFire::ignite(const cv::Point2f & position)
{
...
void Visualizer_SmokeFire::spawnFlame(const Fire & fire)
{
...
void Visualizer_SmokeFire::spawnSmoke(const Fire & fire)
{
...
void Visualizer_SmokeFire::updateSimulation(float deltaTime)
{
...
void Visualizer_SmokeFire::renderFlameParticles(
...
void Visualizer_SmokeFire::renderSmoke(
    sf::RenderWindow & window) const
{
    if (m_smoke.empty())
    {
...
void Visualizer_SmokeFire::resetSimulation()
{
    m_fires.clear();
    m_flames.clear();
    m_smoke.clear();
...
void Visualizer_SmokeFire::init()
{
    resetSimulation();
}

void Visualizer_SmokeFire::imgui()
{
    PROFILE_FUNCTION();
...
void Visualizer_SmokeFire::process(
...
void Visualizer_SmokeFire::render(
    sf::RenderWindow & window)
{
    renderFlameParticles(window);
    renderSmoke(window);
}

void Visualizer_SmokeFire::processEvent(
...
void Visualizer_SmokeFire::save(Settings & save) const
{
    Settings::json & settings = save.section("Visualizer_SmokeFire");
...
void Visualizer_SmokeFire::load(const Settings & save)
{
    const Settings::json & settings = save.section("Visualizer_SmokeFire");
