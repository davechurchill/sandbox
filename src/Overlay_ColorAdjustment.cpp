...
void Overlay_ColorAdjustment::reloadShader()
{
...
void Overlay_ColorAdjustment::resetAdjustments()
{
    m_brightness = 0.0f;
    m_contrast = 1.0f;
    m_exposure = 0.0f;
...
bool Overlay_ColorAdjustment::hasAdjustments() const
{
...
void Overlay_ColorAdjustment::initOverlay()
{
    reloadShader();
}

void Overlay_ColorAdjustment::imguiOverlay()
{
    PROFILE_FUNCTION();
...
void Overlay_ColorAdjustment::processTopographyOverlay(
...
void Overlay_ColorAdjustment::renderOverlay(
...
void Overlay_ColorAdjustment::processOverlayEvent(
    const sf::Event &,
    const sf::Vector2f &,
    TopographyProcessor &)
{
...
void Overlay_ColorAdjustment::saveOverlay(Settings & save) const
{
    Settings::json & settings = save.section("Overlay_ColorAdjustment");
...
void Overlay_ColorAdjustment::loadOverlay(const Settings & save)
{
    const Settings::json & settings = save.section("Overlay_ColorAdjustment");
