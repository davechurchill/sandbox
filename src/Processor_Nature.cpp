...
void Processor_Nature::resetAnimals()
{
    m_sheep.clear();
...
void Processor_Nature::randomizeDirection(Sheep & sheep)
{
...
bool Processor_Nature::spawnSheep(const cv::Point2f & position)
{
...
bool Processor_Nature::spawnRandomSheep(const cv::Mat & terrain)
{
    if (terrain.empty())
    {
        return false;
...
bool Processor_Nature::spawnRandomWolf(const cv::Mat & terrain)
{
    if (terrain.empty())
    {
        return false;
...
void Processor_Nature::updateSheep(const cv::Mat & terrain, float deltaTime)
{
...
void Processor_Nature::updateWolf(const cv::Mat & terrain, float deltaTime)
{
...
void Processor_Nature::drawSheep(
...
void Processor_Nature::drawWolf(
    sf::RenderWindow & window,
    const sf::Vector2f & position,
